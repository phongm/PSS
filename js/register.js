$(function(){
	...
	function checkPhone(){
		...
		console.log(('17780653294').match(regPhone));
	}
...
//			$("#readBox").parent().children(".waring-info").show();
	...
	function getCheckNum(){
		var 
			...
			sNewStr = "【石油科技】您在石油科技请求的验证码是：" + sStr + "，有效时间为1分钟，请不要告诉他人。";
			sNewStr = encodeURIComponent(sNewStr);
		$.ajax({
				type : "get",
				url : "http://apis.baidu.com/kingtto_media/106sms/106sms?mobile=" +  $("#phone").val() +"&content=" + sNewStr,
